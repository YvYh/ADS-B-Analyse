...
# Description: 
# Calculate the number of flights passing by the selected region
# Modifie path before using
# ---------------------------------------------------------------------------
...
gdb = "C:\\Users\\Hong\\Documents\\ArcGIS\\ADS-B\\ADS-B.gdb"

# Load required toolboxes
arcpy.ImportToolbox(workspace+"/ADS-B.tbx")
...
# Process: Expression
arcpy.gp.toolbox = workspace+"/ADS-B.tbx";
...
# Process: Append
arcpy.Append_management(gdb+"\\flight_num", ATF_COUNT, "NO_TEST", "FLIGHT \"FLIGHT\" true true false 2 Short 0 0 ,First,#,"+gdb+"\\flight_num,COUNT_callsign,-1,-1;DATA \"DATA\" true true false 2 Short 0 0 ,First,#,"+gdb+"\\flight_num,COUNT_data,-1,-1;START_TIME \"START_TIME\" true true false 50 Text 0 0 ,First,#,"+gdb+"\\flight_num,start_time,-1,-1;END_TIME \"END_TIME\" true true false 50 Text 0 0 ,First,#,"+gdb+"\\flight_num,end_time,-1,-1;PROVINCE \"PROVINCE\" true true false 50 Text 0 0 ,First,#,"+gdb+"\\flight_num,PROVINCE,-1,-1", "")
